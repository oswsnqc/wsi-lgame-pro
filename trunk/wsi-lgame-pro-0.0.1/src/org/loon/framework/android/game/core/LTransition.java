...
public class LTransition {
	...
	public final static LTransition newCrossRandom(LColor color) {
		return newCross(LSystem.getRandomBetween(0, 1), GraphicsUtils.createImage(LSystem.screenRect.width, LSystem.screenRect.height, color));
	}
	...
	public final static LTransition newScale() {
		...
		transition.setTransitionListener(new TransitionListener() {
			...
			final ScaleEffect scale = new ScaleEffect(ScreenUtils.toScreenCaptureImage(), true);
	 ...
	 * @return
	 */
	public final static LTransition newArc(final LColor color) {
		final LTransition transition = new LTransition();

		transition.setTransitionListener(new TransitionListener() {
			final ArcEffect arc = new ArcEffect(color);
	...
	public final static LTransition newSplitRandom(LColor c) {
		return newSplitRandom(GraphicsUtils.createImage(LSystem.screenRect.width, LSystem.screenRect.height, c));
	}
	...
	public final static LTransition newOut(final int type) {
		...
		transition.setTransitionListener(new TransitionListener() {
			...
			final OutEffect out = new OutEffect(ScreenUtils.toScreenCaptureImage(), type);
