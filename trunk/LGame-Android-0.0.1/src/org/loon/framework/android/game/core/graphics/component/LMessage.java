...
public class LMessage extends LContainer {
	...
	/**
	 * 消息对话框的消息，宽和高默认为 消息对话框图片的宽和高
	 * 
	 * @param formImage	： 消息对话框的图片，LImage 实例
	 * @param x		： 左上角坐标的 x 值
	 * @param y		： 左上角坐标的 y 值
	 */
	...
	private void updateIcon() {
		this.setPauseIconAnimationLocation(getScreenX() + getWidth() - dw / 2 - 20, getScreenY() + getHeight() - dh - 10);
	}
