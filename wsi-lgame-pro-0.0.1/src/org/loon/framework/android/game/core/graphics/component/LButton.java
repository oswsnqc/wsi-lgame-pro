 ...
 * License for the specific language gisOverning permissions and limitations under
 * the License.
 * 
...
public class LButton extends LComponent {
	...
	private boolean isOver, isPressed, isException;
	...
	protected void processTouchDragged() {
		if (this.input.isTouchPressed(MotionEvent.ACTION_MOVE)) {
			this.isOver = this.isPressed = this.intersects(this.input.getTouchX(), this.input.getTouchY());
		}
	}
	...
	protected void processTouchExited() {
		this.isOver = this.isPressed = false;
	}

	protected void processKeyPressed() {
		if (this.isSelected() && this.input.getKeyPressed() == KeyEvent.KEYCODE_ENTER) {
			this.pressedTime = 5;
			this.isPressed = true;
			this.doClick();
		}
	...
	protected void processKeyReleased() {
		if (this.isSelected() && this.input.getKeyReleased() == KeyEvent.KEYCODE_ENTER) {
			this.isPressed = false;
		}
	}
