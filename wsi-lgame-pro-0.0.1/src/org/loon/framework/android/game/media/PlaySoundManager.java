...
public class PlaySoundManager {
	...
	private void initSoundPool() {
		if (soundPool == null) {
			soundPool = new android.media.SoundPool(numStreams, android.media.AudioManager.STREAM_MUSIC, 100);
		}
	}
	...
	public void play(PlaySound play, float v, boolean loop) {
		synchronized (this) {
			...
			int stream = soundPool.play(play.getSoundId(), vol, vol, 1, loop ? -1 : 0, 1f);
